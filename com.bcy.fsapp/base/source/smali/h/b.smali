...
.method public a(Z)V
    ...
    iput-boolean v0, p0, Lh/b;->r:Z

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v1

    iget-object v3, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v10, p0, Lh/b;->m:Lh/b$d;
    ...
    :cond_1
    :goto_0
    iput-wide v7, p0, Lh/b;->v:J

    :cond_2
    move v3, v6

    :goto_1
    iget-object v9, p0, Lh/b;->p:Landroid/graphics/drawable/Drawable;

    if-eqz v9, :cond_4

    iget-wide v10, p0, Lh/b;->w:J
    ...
    iput-object v0, p0, Lh/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Lh/b;->m:Lh/b$d;
    ...
    iget-object p1, p0, Lh/b;->u:Ljava/lang/Runnable;
...
.method public applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v0, p0, Lh/b;->m:Lh/b$d;
...
.method public final d(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, Lh/b;->x:Lh/b$c;
    ...
    iput-object v0, p0, Lh/b;->x:Lh/b$c;
    ...
    iget-object v1, p0, Lh/b;->m:Lh/b$d;

    iget-boolean v1, v1, Lh/b$d;->C:Z

    invoke-static {p1, v1}, Landroidx/core/graphics/drawable/a;->j(Landroid/graphics/drawable/Drawable;Z)V

    :cond_6
    iget-object v1, p0, Lh/b;->n:Landroid/graphics/Rect;
    ...
    invoke-static {p1, v0, v2, v3, v1}, Landroidx/core/graphics/drawable/a;->l(Landroid/graphics/drawable/Drawable;IIII)V
    :try_end_0
    ...
    iget-object v1, p0, Lh/b;->x:Lh/b$c;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v0, p0, Lh/b;->p:Landroid/graphics/drawable/Drawable;
...
.method public g(I)Z
    ...
    iput-wide v0, p0, Lh/b;->w:J

    goto :goto_0

    :cond_2
    iput-object v4, p0, Lh/b;->p:Landroid/graphics/drawable/Drawable;

    iput-wide v5, p0, Lh/b;->w:J
    ...
    iput-object v0, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;

    iput p1, p0, Lh/b;->s:I

    if-eqz v0, :cond_7

    iget-object p1, p0, Lh/b;->m:Lh/b$d;
    ...
    iput-wide v2, p0, Lh/b;->v:J

    :cond_5
    invoke-virtual {p0, v0}, Lh/b;->d(Landroid/graphics/drawable/Drawable;)V

    goto :goto_1

    :cond_6
    iput-object v4, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Lh/b;->u:Ljava/lang/Runnable;
...
.method public getHotspotBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lh/b;->n:Landroid/graphics/Rect;
...
.method public h(Lh/b$d;)V
    ...
    iput-object p1, p0, Lh/b;->m:Lh/b$d;
    ...
    iput-object p1, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lh/b;->d(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    const/4 p1, 0x0

    iput-object p1, p0, Lh/b;->p:Landroid/graphics/drawable/Drawable;
...
.method public jumpToCurrentState()V
    ...
    :goto_0
    iget-object v2, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Landroid/graphics/drawable/Drawable;->jumpToCurrentState()V

    iget-boolean v2, p0, Lh/b;->r:Z
    ...
    iput-wide v4, p0, Lh/b;->w:J

    move v0, v1

    :cond_2
    iget-wide v2, p0, Lh/b;->v:J

    cmp-long v2, v2, v4

    if-eqz v2, :cond_3

    iput-wide v4, p0, Lh/b;->v:J
...
.method public setHotspotBounds(IIII)V
    ...
    iput-object v0, p0, Lh/b;->n:Landroid/graphics/Rect;
...
.method public setVisible(ZZ)Z
    ...
    iget-object v1, p0, Lh/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Lh/b;->o:Landroid/graphics/drawable/Drawable;
