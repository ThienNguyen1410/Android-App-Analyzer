...
.method public constructor <init>(Lio/flutter/embedding/engine/FlutterJNI;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/engine/renderer/a;->f:Lrf/a;

    iput-object p1, p0, Lio/flutter/embedding/engine/renderer/a;->a:Lio/flutter/embedding/engine/FlutterJNI;

    invoke-virtual {p1, v0}, Lio/flutter/embedding/engine/FlutterJNI;->addIsDisplayingFlutterUiListener(Lrf/a;)V

    return-void
.end method

.method public static synthetic b(Lio/flutter/embedding/engine/renderer/a;Z)Z
    .locals 0
...
.method public static synthetic c(Lio/flutter/embedding/engine/renderer/a;)Lio/flutter/embedding/engine/FlutterJNI;
    .locals 0
...
.method public static synthetic d(Lio/flutter/embedding/engine/renderer/a;J)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lio/flutter/embedding/engine/renderer/a;->k(J)V

    return-void
.end method

.method public static synthetic e(Lio/flutter/embedding/engine/renderer/a;J)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lio/flutter/embedding/engine/renderer/a;->u(J)V

    return-void
.end method

.method public static synthetic f(Lio/flutter/embedding/engine/renderer/a;)Landroid/os/Handler;
    .locals 0
...
.method public a()Lio/flutter/view/d$a;
    ...
    invoke-virtual {p0, v0}, Lio/flutter/embedding/engine/renderer/a;->l(Landroid/graphics/SurfaceTexture;)Lio/flutter/view/d$a;
...
.method public g(Lrf/a;)V
    .locals 1

    iget-object v0, p0, Lio/flutter/embedding/engine/renderer/a;->a:Lio/flutter/embedding/engine/FlutterJNI;

    invoke-virtual {v0, p1}, Lio/flutter/embedding/engine/FlutterJNI;->addIsDisplayingFlutterUiListener(Lrf/a;)V
...
.method public l(Landroid/graphics/SurfaceTexture;)Lio/flutter/view/d$a;
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/renderer/a$f;->id()J
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/renderer/a$f;->e()Lio/flutter/embedding/engine/renderer/SurfaceTextureWrapper;

    move-result-object p1

    invoke-virtual {p0, v1, v2, p1}, Lio/flutter/embedding/engine/renderer/a;->m(JLio/flutter/embedding/engine/renderer/SurfaceTextureWrapper;)V
...
.method public n(Lrf/a;)V
    .locals 1

    iget-object v0, p0, Lio/flutter/embedding/engine/renderer/a;->a:Lio/flutter/embedding/engine/FlutterJNI;

    invoke-virtual {v0, p1}, Lio/flutter/embedding/engine/FlutterJNI;->removeIsDisplayingFlutterUiListener(Lrf/a;)V
...
.method public p(Lio/flutter/embedding/engine/renderer/a$g;)V
    .locals 23
    ...
    iget v4, v4, Lio/flutter/embedding/engine/renderer/a$d;->m:I

    aput v4, v15, v2

    iget-object v3, v3, Lio/flutter/embedding/engine/renderer/a$b;->c:Lio/flutter/embedding/engine/renderer/a$c;

    iget v3, v3, Lio/flutter/embedding/engine/renderer/a$c;->m:I
...
.method public q(Landroid/view/Surface;Z)V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/engine/renderer/a;->r()V
...
.method public r()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/renderer/a;->f:Lrf/a;
