...
.field private deferredComponentManager:Lhf/a;
...
.field private localizationPlugin:Luf/a;

.field private final mainLooper:Landroid/os/Looper;

.field private nativeShellHolderId:Ljava/lang/Long;

.field private platformMessageHandler:Lgf/d;

.field private platformViewsController:Lio/flutter/plugin/platform/l;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p1, p2}, Lff/c;-><init>(J)V
    ...
    invoke-static {p1, p2, p0}, Ldf/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lgf/d;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lgf/d;->e(ILjava/nio/ByteBuffer;)V
...
.method public addIsDisplayingFlutterUiListener(Lrf/a;)V
    .locals 1
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Luf/a;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Luf/a;

    invoke-virtual {p1, v0}, Luf/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/l;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->A()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Ltf/q;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/c$g;->m:I
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lgf/d;->f(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public invokePlatformMessageEmptyResponseCallback(I)V
    ...
    invoke-static {v0, p1}, Ldf/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->Q()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/l;->S(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/l;
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/l;->T(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->U()V
...
.method public removeIsDisplayingFlutterUiListener(Lrf/a;)V
    .locals 1
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lhf/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lhf/a;->b(ILjava/lang/String;)V
    ...
    invoke-static {p1, v0}, Ldf/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setDeferredComponentManager(Lhf/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lhf/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Lhf/a;->e(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Luf/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Luf/a;

    return-void
.end method

.method public setPlatformMessageHandler(Lgf/d;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lgf/d;

    return-void
.end method

.method public setPlatformViewsController(Lio/flutter/plugin/platform/l;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/l;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lfg/b;->a(ZLjava/lang/Object;)V
