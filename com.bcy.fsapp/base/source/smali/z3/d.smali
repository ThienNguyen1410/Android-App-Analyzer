...
.method public bridge synthetic a(Ljava/lang/Object;IILo3/f;)Lq3/v;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lz3/d;->c(Landroid/net/Uri;IILo3/f;)Lq3/v;
...
.method public bridge synthetic b(Ljava/lang/Object;Lo3/f;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lz3/d;->h(Landroid/net/Uri;Lo3/f;)Z
...
.method public c(Landroid/net/Uri;IILo3/f;)Lq3/v;
    ...
    invoke-virtual {p0, p1, p2}, Lz3/d;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Lz3/d;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, Lz3/d;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lz3/a;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object p1, p0, Lz3/d;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p1, p2}, Lz3/d;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p2}, Lz3/d;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;Lo3/f;)Z
    .locals 0
