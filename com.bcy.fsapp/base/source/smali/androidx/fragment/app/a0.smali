...
.method public static d(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/fragment/app/a0;->h(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroidx/fragment/app/a0;->h(Ljava/util/List;Landroid/view/View;I)Z

    move-result v5

    if-nez v5, :cond_2

    invoke-static {v4}, Lp0/x;->N(Landroid/view/View;)Ljava/lang/String;
...
.method public f(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Lp0/a0;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/a0;->f(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method public j(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/a0;->j(Ljava/util/Map;Landroid/view/View;)V
...
.method public o(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lp0/x;->N(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lp0/x;->G0(Landroid/view/View;Ljava/lang/String;)V
...
.method public s(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/a0$c;-><init>(Landroidx/fragment/app/a0;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Lp0/u;->a(Landroid/view/View;Ljava/lang/Runnable;)Lp0/u;
...
.method public w(Landroidx/fragment/app/Fragment;Ljava/lang/Object;Ll0/b;Ljava/lang/Runnable;)V
    .locals 0
...
.method public x(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/a0$b;-><init>(Landroidx/fragment/app/a0;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method public y(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Lp0/x;->G0(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroidx/fragment/app/a0$a;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/fragment/app/a0$a;-><init>(Landroidx/fragment/app/a0;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Lp0/u;->a(Landroid/view/View;Ljava/lang/Runnable;)Lp0/u;
