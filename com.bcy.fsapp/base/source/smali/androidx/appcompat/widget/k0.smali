...
.field public static i:Landroidx/appcompat/widget/k0;

.field public static final j:Landroidx/appcompat/widget/k0$c;
...
.field public g:Landroidx/appcompat/widget/k0$f;
...
.method public static declared-synchronized l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/k0$c;->k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/k0$c;->l(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static p(Landroidx/appcompat/widget/k0;)V
    .locals 2
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/appcompat/widget/k0;->a(Ljava/lang/String;Landroidx/appcompat/widget/k0$e;)V
...
.method public static w(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/s0;[I)V
    .locals 2
...
# virtual methods
.method public final a(Ljava/lang/String;Landroidx/appcompat/widget/k0$e;)V
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/k0;->b:Ls/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/k0;->b:Ls/g;
...
.method public final declared-synchronized b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Ls/d;->v(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Ls/h;->b(ILjava/lang/Object;)V
...
.method public final f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v1, v2}, Landroidx/appcompat/widget/k0;->i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/k0$f;->c(Landroidx/appcompat/widget/k0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v1, v2, p2}, Landroidx/appcompat/widget/k0;->b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method public final declared-synchronized i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Ls/d;->m(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Ls/d;->w(J)V
    :try_end_2
...
.method public declared-synchronized k(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/k0;->d(Landroid/content/Context;)V

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/k0;->r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/k0;->f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/k0;->v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/k0;->n(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/k0$f;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/k0;->c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2}, Ls/h;->h(I)Ljava/lang/Object;
...
.method public o(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/k0$f;->b(I)Landroid/graphics/PorterDuff$Mode;
...
.method public final r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/k0;->c:Ls/h;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, Ls/h;->h(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/k0;->b:Ls/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/k0;->c:Ls/h;
    ...
    invoke-virtual {p0, p1, v4, v5}, Landroidx/appcompat/widget/k0;->i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/k0;->c:Ls/h;

    invoke-virtual {v8, p2, v3}, Ls/h;->b(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/k0;->b:Ls/g;
    ...
    invoke-virtual {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/k0;->b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct {p1, v0}, Lorg/xmlpull/v1/a;-><init>(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/k0;->c:Ls/h;

    invoke-virtual {p1, p2, v2}, Ls/h;->b(ILjava/lang/Object;)V
...
.method public declared-synchronized t(Landroid/content/Context;Landroidx/appcompat/widget/z0;I)Landroid/graphics/drawable/Drawable;
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-virtual {p0, p1, p3}, Landroidx/appcompat/widget/k0;->r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/z0;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/k0;->v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public final v(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/k0$f;->e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method public x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/k0$f;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
