...
.method public final a()Lk/d;
    ...
    invoke-virtual {v0, v1}, Lk/d;->l(Landroidx/appcompat/view/menu/e;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Lk/d;->u(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Lk/d;->p(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lk/d;->r(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/h;->g:I

    invoke-virtual {v0, v1}, Lk/d;->s(I)V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/h;->j:Lk/d;
...
.method public c()Lk/d;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->a()Lk/d;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/h;->j:Lk/d;
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Lk/d;->r(Z)V
...
.method public final l(IIZZ)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->c()Lk/d;

    move-result-object v0

    invoke-virtual {v0, p4}, Lk/d;->v(Z)V
    ...
    invoke-static {p4}, Lp0/x;->E(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Lp0/f;->b(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lk/d;->t(I)V

    invoke-virtual {v0, p2}, Lk/d;->w(I)V
    ...
    invoke-virtual {v0, p4}, Lk/d;->q(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Lk/f;->b()V
