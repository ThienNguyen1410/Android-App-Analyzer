...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->windowLayoutInfo(Landroid/app/Activity;)Lvh/b;
.end annotation
...
# direct methods
.method public constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lbh/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic a(Luh/f;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invokeSuspend$lambda-0(Luh/f;Landroidx/window/layout/WindowLayoutInfo;)V

    return-void
.end method

.method private static final invokeSuspend$lambda-0(Luh/f;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Luh/t;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final create(Ljava/lang/Object;Lbh/d;)Lbh/d;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lbh/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lvh/c;Lbh/d;)Ljava/lang/Object;
...
.method public final invoke(Lvh/c;Lbh/d;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Lbh/d;)Lbh/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Luh/e;->n:Luh/e;

    const/4 v5, 0x4

    const/4 v6, 0x0

    invoke-static {v1, v4, v6, v5, v6}, Luh/h;->b(ILuh/e;Ljh/l;ILjava/lang/Object;)Luh/f;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/c;

    invoke-direct {v4, v1}, Landroidx/window/layout/c;-><init>(Luh/f;)V
    ...
    sget-object v7, Landroidx/window/layout/b;->m:Landroidx/window/layout/b;

    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/WindowBackend;->registerLayoutChangeCallback(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lo0/a;)V

    :try_start_2
    invoke-interface {v1}, Luh/p;->iterator()Luh/g;
    ...
    invoke-interface {v1, v5}, Luh/g;->a(Lbh/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Luh/g;->next()Ljava/lang/Object;
    ...
    invoke-interface {v6, p1, v5}, Lvh/c;->emit(Ljava/lang/Object;Lbh/d;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lo0/a;)V
    ...
    invoke-interface {v0, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lo0/a;)V
