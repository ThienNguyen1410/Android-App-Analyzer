...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lg7/h;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lg7/h;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static b(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lg7/a;->H(I)Ljava/lang/String;
...
.method public static d(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lp7/c;->a(Landroid/content/Context;)Lp7/b;
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/common/b;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lcom/google/android/gms/common/b;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lg7/h;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lg7/h;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lg7/h;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Ln7/g;->b()Z
...
.method public static e(Landroid/content/Context;I)I
    ...
    sget-object v1, Lg7/h;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Lj7/e0;->a(Landroid/content/Context;)I
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Ln7/g;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ln7/g;->f(Landroid/content/Context;)Z
    ...
    :goto_3
    invoke-static {v5}, Lcom/google/android/gms/common/internal/h;->a(Z)V
    ...
    invoke-static {v9, v3}, Lcom/google/android/gms/common/b;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Lcom/google/android/gms/common/b;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Ln7/n;->a(I)I

    move-result p0

    invoke-static {p1}, Ln7/n;->a(I)I
...
.method public static f(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lg7/h;->j(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static i(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Ln7/l;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method public static j(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lg7/h;->g(Landroid/content/Context;)Z
