...
# instance fields
.field public final synthetic m:Lsf/i;
...
.method public constructor <init>(Lsf/i;)V
    ...
    iput-object p1, p0, Lsf/i$a;->m:Lsf/i;
...
.method public i(Ltf/i;Ltf/j$d;)V
    ...
    iget-object v1, p0, Lsf/i$a;->m:Lsf/i;

    invoke-static {v1}, Lsf/i;->a(Lsf/i;)Lsf/i$h;
    ...
    :pswitch_0
    iget-object p1, p0, Lsf/i$a;->m:Lsf/i;

    invoke-static {p1}, Lsf/i;->a(Lsf/i;)Lsf/i$h;

    move-result-object p1

    invoke-interface {p1}, Lsf/i$h;->m()Z
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->d(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Ltf/j$d;->a(Ljava/lang/Object;)V
    ...
    :try_start_2
    invoke-static {p1}, Lsf/i$e;->g(Ljava/lang/String;)Lsf/i$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Ltf/j$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Lsf/i$a;->m:Lsf/i;

    invoke-static {v2}, Lsf/i;->a(Lsf/i;)Lsf/i$h;

    move-result-object v2

    invoke-interface {v2, p1}, Lsf/i$h;->f(Lsf/i$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p2, v2}, Ltf/j$d;->a(Ljava/lang/Object;)V
    ...
    invoke-interface {p1}, Lsf/i$h;->b()V
    :try_end_3
    ...
    invoke-static {v1, p1}, Lsf/i;->f(Lsf/i;Lorg/json/JSONObject;)Lsf/i$j;
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->a(Lsf/i$j;)V
    ...
    invoke-interface {p1}, Lsf/i$h;->j()V
    ...
    invoke-interface {p1}, Lsf/i$h;->i()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Lsf/i;->e(Lsf/i;Ljava/lang/String;)Lsf/i$k;
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->h(Lsf/i$k;)V
    ...
    invoke-static {v1, p1}, Lsf/i;->d(Lsf/i;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->c(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Lsf/i;->c(Lsf/i;Lorg/json/JSONObject;)Lsf/i$c;
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->e(Lsf/i$c;)V
    ...
    invoke-static {v1, p1}, Lsf/i;->b(Lsf/i;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->l(I)V
    ...
    invoke-static {p1}, Lsf/i$g;->g(Ljava/lang/String;)Lsf/i$g;
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->g(Lsf/i$g;)V
    ...
    invoke-static {p1}, Lsf/i$i;->g(Ljava/lang/String;)Lsf/i$i;
    ...
    invoke-interface {v1, p1}, Lsf/i$h;->k(Lsf/i$i;)V
