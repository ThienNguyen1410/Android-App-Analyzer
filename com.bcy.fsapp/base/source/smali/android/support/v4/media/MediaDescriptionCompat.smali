...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Ljava/lang/CharSequence;
    ...
    iput-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->q:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->r:Landroid/net/Uri;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->readBundle(Ljava/lang/ClassLoader;)Landroid/os/Bundle;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->s:Landroid/os/Bundle;
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->t:Landroid/net/Uri;
...
.method public b()Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->m:Ljava/lang/String;

    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->g(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->n:Ljava/lang/CharSequence;

    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->i(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Ljava/lang/CharSequence;

    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->h(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->p:Ljava/lang/CharSequence;

    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->c(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->q:Landroid/graphics/Bitmap;

    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->e(Ljava/lang/Object;Landroid/graphics/Bitmap;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->r:Landroid/net/Uri;

    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->f(Ljava/lang/Object;Landroid/net/Uri;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->s:Landroid/os/Bundle;

    const/16 v3, 0x17

    if-ge v1, v3, :cond_2

    iget-object v4, p0, Landroid/support/v4/media/MediaDescriptionCompat;->t:Landroid/net/Uri;
    ...
    :cond_2
    invoke-static {v0, v2}, Landroid/support/v4/media/a$a;->d(Ljava/lang/Object;Landroid/os/Bundle;)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->m:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->q:Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->s:Landroid/os/Bundle;
