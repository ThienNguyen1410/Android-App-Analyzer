...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0}, Landroid/support/v4/media/session/a;->I()V
    ...
    :cond_0
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/a;->W(Z)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->o0(I)V
    ...
    :cond_3
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->e(Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->f(Ljava/util/List;)V
    ...
    :cond_5
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->m0(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    :cond_7
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/a;->n(Ljava/lang/String;Landroid/os/Bundle;)V
