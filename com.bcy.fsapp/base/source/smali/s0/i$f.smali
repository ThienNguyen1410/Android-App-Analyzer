...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Ls0/i$f;->a:Landroid/view/ActionMode$Callback;

    iput-object p2, p0, Ls0/i$f;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    iput-boolean p1, p0, Ls0/i$f;->f:Z
...
.method public final b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Ls0/i$f;->a()Landroid/content/Intent;

    move-result-object v0

    invoke-virtual {p0, p2}, Ls0/i$f;->d(Landroid/widget/TextView;)Z
...
.method public final c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-virtual {p0, v1, p1}, Ls0/i$f;->e(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method public final e(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
    .locals 3
...
.method public final f(Landroid/view/Menu;)V
    ...
    iget-object v0, p0, Ls0/i$f;->b:Landroid/widget/TextView;
    ...
    iget-boolean v2, p0, Ls0/i$f;->f:Z
    ...
    iput-boolean v5, p0, Ls0/i$f;->f:Z
    ...
    iput-object v2, p0, Ls0/i$f;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Ls0/i$f;->d:Ljava/lang/reflect/Method;

    iput-boolean v5, p0, Ls0/i$f;->e:Z
    :try_end_0
    ...
    iput-boolean v4, p0, Ls0/i$f;->e:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Ls0/i$f;->e:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Ls0/i$f;->c:Ljava/lang/Class;
    ...
    iget-object v2, p0, Ls0/i$f;->d:Ljava/lang/reflect/Method;
    ...
    :cond_3
    invoke-virtual {p0, v0, v1}, Ls0/i$f;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Ls0/i$f;->b:Landroid/widget/TextView;

    invoke-virtual {p0, v3, v7}, Ls0/i$f;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Ls0/i$f;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0, p2}, Ls0/i$f;->f(Landroid/view/Menu;)V
