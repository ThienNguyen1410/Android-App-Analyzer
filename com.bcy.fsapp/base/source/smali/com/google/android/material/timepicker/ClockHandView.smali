...
# instance fields
.field public A:Lcom/google/android/material/timepicker/ClockHandView$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->s:Ljava/util/List;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->v:Landroid/graphics/Paint;

    new-instance v1, Landroid/graphics/RectF;

    invoke-direct {v1}, Landroid/graphics/RectF;-><init>()V

    iput-object v1, p0, Lcom/google/android/material/timepicker/ClockHandView;->w:Landroid/graphics/RectF;

    sget-object v1, Li8/k;->J0:[I
...
.method public b(Lcom/google/android/material/timepicker/ClockHandView$d;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->s:Ljava/util/List;
...
.method public final c(Landroid/graphics/Canvas;)V
    ...
    iget-wide v3, p0, Lcom/google/android/material/timepicker/ClockHandView;->B:D
    ...
    iget v3, p0, Lcom/google/android/material/timepicker/ClockHandView;->C:I

    int-to-float v3, v3

    iget-wide v4, p0, Lcom/google/android/material/timepicker/ClockHandView;->B:D
    ...
    iget-object v4, p0, Lcom/google/android/material/timepicker/ClockHandView;->v:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Lcom/google/android/material/timepicker/ClockHandView;->v:Landroid/graphics/Paint;

    invoke-virtual {p1, v2, v3, v4, v5}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-wide v2, p0, Lcom/google/android/material/timepicker/ClockHandView;->B:D
    ...
    iget-object v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->v:Landroid/graphics/Paint;

    iget v1, p0, Lcom/google/android/material/timepicker/ClockHandView;->x:I

    int-to-float v1, v1

    invoke-virtual {v0, v1}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iget-object v7, p0, Lcom/google/android/material/timepicker/ClockHandView;->v:Landroid/graphics/Paint;
    ...
    iget v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->u:F

    iget-object v1, p0, Lcom/google/android/material/timepicker/ClockHandView;->v:Landroid/graphics/Paint;
...
.method public f()F
    ...
    iget v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->y:F
...
.method public final i(FFZZZ)Z
    ...
    iget-boolean p2, p0, Lcom/google/android/material/timepicker/ClockHandView;->n:Z
...
.method public j(I)V
    ...
    iput p1, p0, Lcom/google/android/material/timepicker/ClockHandView;->C:I
...
.method public l(FZ)V
    ...
    iget-object v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->m:Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, Lcom/google/android/material/timepicker/ClockHandView;->m:Landroid/animation/ValueAnimator;

    const-wide/16 v0, 0xc8

    invoke-virtual {p1, v0, v1}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object p1, p0, Lcom/google/android/material/timepicker/ClockHandView;->m:Landroid/animation/ValueAnimator;
...
.method public final m(FZ)V
    ...
    iput-wide v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->B:D
    ...
    iget-object v2, p0, Lcom/google/android/material/timepicker/ClockHandView;->w:Landroid/graphics/RectF;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget v2, p0, Lcom/google/android/material/timepicker/ClockHandView;->o:F

    sub-float v2, v7, v2

    float-to-int v2, v2

    iget v3, p0, Lcom/google/android/material/timepicker/ClockHandView;->p:F
    ...
    iget-boolean v2, p0, Lcom/google/android/material/timepicker/ClockHandView;->z:Z
    ...
    :cond_3
    iput v7, p0, Lcom/google/android/material/timepicker/ClockHandView;->o:F

    iput p1, p0, Lcom/google/android/material/timepicker/ClockHandView;->p:F

    iput-boolean v8, p0, Lcom/google/android/material/timepicker/ClockHandView;->q:Z

    iput-boolean v1, p0, Lcom/google/android/material/timepicker/ClockHandView;->z:Z
    ...
    :goto_2
    iget-boolean v9, p0, Lcom/google/android/material/timepicker/ClockHandView;->z:Z
    ...
    iget-object v0, p0, Lcom/google/android/material/timepicker/ClockHandView;->A:Lcom/google/android/material/timepicker/ClockHandView$c;
    ...
    iget-boolean v1, p0, Lcom/google/android/material/timepicker/ClockHandView;->q:Z
