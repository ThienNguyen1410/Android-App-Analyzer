...
# virtual methods
.method public final O(Landroid/widget/TextView;Landroid/widget/TextView;)Landroid/util/Pair;
    .locals 7
...
.method public final P(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p1}, Lf9/g;->M(Landroid/content/Context;)V
    ...
    invoke-static {p0, v1}, Lp0/x;->v0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    return-void
.end method

.method public final Q(Landroid/view/View;Landroid/util/Pair;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final R()V
    ...
    :cond_0
    invoke-static {p0}, Ly8/i;->c(Landroidx/appcompat/widget/Toolbar;)Landroid/widget/TextView;

    move-result-object v0

    invoke-static {p0}, Ly8/i;->a(Landroidx/appcompat/widget/Toolbar;)Landroid/widget/TextView;
    ...
    :cond_1
    invoke-virtual {p0, v0, v1}, Lcom/google/android/material/appbar/MaterialToolbar;->O(Landroid/widget/TextView;Landroid/widget/TextView;)Landroid/util/Pair;
    ...
    invoke-virtual {p0, v0, v2}, Lcom/google/android/material/appbar/MaterialToolbar;->Q(Landroid/view/View;Landroid/util/Pair;)V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/google/android/material/appbar/MaterialToolbar;->Q(Landroid/view/View;Landroid/util/Pair;)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/appbar/MaterialToolbar;->R()V
