...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ll1/c;->Y:[Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Ll1/c$b;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Ll1/c;->Z:Landroid/util/Property;
    ...
    invoke-direct {v0, v1, v2}, Ll1/c$c;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Ll1/c;->a0:Landroid/util/Property;
    ...
    invoke-direct {v0, v1, v3}, Ll1/c$d;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Ll1/c;->b0:Landroid/util/Property;

    new-instance v0, Ll1/c$e;

    const-class v1, Landroid/graphics/PointF;

    invoke-direct {v0, v1, v3}, Ll1/c$e;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Ll1/c;->c0:Landroid/util/Property;

    new-instance v0, Ll1/c$f;

    const-class v1, Landroid/graphics/PointF;

    invoke-direct {v0, v1, v2}, Ll1/c$f;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Ll1/c;->d0:Landroid/util/Property;
    ...
    invoke-direct {v0, v1, v2}, Ll1/c$g;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Ll1/c;->e0:Landroid/util/Property;

    new-instance v0, Ll1/k;

    invoke-direct {v0}, Ll1/k;-><init>()V

    sput-object v0, Ll1/c;->f0:Ll1/k;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ll1/c;->V:[I

    const/4 v0, 0x0

    iput-boolean v0, p0, Ll1/c;->W:Z
...
.method public Z()[Ljava/lang/String;
    ...
    sget-object v0, Ll1/c;->Y:[Ljava/lang/String;
...
.method public m(Ll1/s;)V
    ...
    invoke-virtual {p0, p1}, Ll1/c;->y0(Ll1/s;)V
...
.method public x(Landroid/view/ViewGroup;Ll1/s;Ll1/s;)Landroid/animation/Animator;
    ...
    invoke-virtual {v8, v3, v4}, Ll1/c;->z0(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {v9, v6, v11, v13, v3}, Ll1/c0;->f(Landroid/view/View;IIII)V
    ...
    invoke-virtual/range {p0 .. p0}, Ll1/m;->K()Ll1/g;
    ...
    sget-object v1, Ll1/c;->e0:Landroid/util/Property;
    ...
    sget-object v4, Ll1/c;->a0:Landroid/util/Property;
    ...
    sget-object v4, Ll1/c;->b0:Landroid/util/Property;
    ...
    sget-object v1, Ll1/c;->c0:Landroid/util/Property;
    ...
    sget-object v1, Ll1/c;->d0:Landroid/util/Property;
    ...
    invoke-static {v9, v6, v11, v1, v3}, Ll1/c0;->f(Landroid/view/View;IIII)V
    ...
    sget-object v3, Ll1/c;->e0:Landroid/util/Property;
    ...
    invoke-static {v9, v1}, Lp0/x;->y0(Landroid/view/View;Landroid/graphics/Rect;)V

    sget-object v4, Ll1/c;->f0:Ll1/k;
    ...
    invoke-virtual {v8, v2}, Ll1/m;->b(Ll1/m$f;)Ll1/m;
    ...
    invoke-static {v9}, Ll1/c0;->c(Landroid/view/View;)F

    move-result v7

    const/4 v4, 0x0

    invoke-static {v9, v4}, Ll1/c0;->g(Landroid/view/View;F)V

    invoke-static/range {p1 .. p1}, Ll1/c0;->b(Landroid/view/View;)Ll1/b0;

    move-result-object v4

    invoke-interface {v4, v6}, Ll1/b0;->a(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual/range {p0 .. p0}, Ll1/m;->K()Ll1/g;

    move-result-object v4

    iget-object v10, v8, Ll1/c;->V:[I
    ...
    sget-object v1, Ll1/c;->Z:Landroid/util/Property;

    invoke-static {v1, v0}, Ll1/i;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
...
.method public final y0(Ll1/s;)V
    ...
    iget-boolean v1, p0, Ll1/c;->X:Z

    if-eqz v1, :cond_1

    iget-object v1, p1, Ll1/s;->b:Landroid/view/View;

    iget-object v2, p0, Ll1/c;->V:[I
    ...
    :cond_1
    iget-boolean v1, p0, Ll1/c;->W:Z

    if-eqz v1, :cond_2

    iget-object p1, p1, Ll1/s;->a:Ljava/util/Map;

    invoke-static {v0}, Lp0/x;->w(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public final z0(Landroid/view/View;Landroid/view/View;)Z
    .locals 3

    iget-boolean v0, p0, Ll1/c;->X:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, v1}, Ll1/m;->F(Landroid/view/View;Z)Ll1/s;
