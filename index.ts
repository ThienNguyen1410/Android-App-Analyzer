...
const appStore = new AppStoreRepoImpl();
...
const searchPackage = async () => {
  const app = await appStore.searchAppById("1112407590");
  const info: iOSApp = {
    id: app.id,
    appId: app.appId,
    title: app.title,
  ...
  // const appInfos = await appStore.searchAppByKeywords("Sport");
  // appInfos.forEach((app: any) => {
  //   const info: iOSApp = {
  //     id: app.id,
  //     appId: app.appId,
  //     title: app.title,
